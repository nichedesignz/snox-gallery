...
//           )}
//         </div> */}
//  <div className={`gallery-container ${images.length > 50 ? "more-than-50" : "less-than-50"}`}>
//           {images.length > 0 ? (
//             images.map((image, index) => (
//               <div key={image.uuid} className="gallery-item">
//                 <LazyImageComponent
...
//   );
// }
// const LazyImageComponent = ({ src, alt, onClick }) => {
...
//         setLoaded(true); // Set loaded to true when the image enters the viewport
//         observer.disconnect();
//       }
//     });
...
//           cursor: "pointer",
//           opacity: loaded ? 1 : 0, 
//           transition: loaded ? "opacity 0.9s ease-in-out" : "none", 
//         }}
//       />
//     </div>
//   );
